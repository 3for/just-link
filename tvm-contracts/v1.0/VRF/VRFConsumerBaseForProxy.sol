 ...
 */
abstract contract VRFConsumerBaseForProxy is VRFCoordinatorInterface, VRFRequestIDBase, JustlinkClient {
    using SignedSafeMath for int256;

    event VRFRequested(bytes32 indexed id);

    VRFCoordinatorInterface private vrfCoordinator;
    address private vrfCoordinatorProxy;
    ...
    */
      ...
      internal returns (bytes32 requestId)
    {
        ...
        require(justMid.transferAndCall(address(this), vrfCoordinatorProxy, _fee, encodeVRFRequest(_req)), "unable to transferAndCall to vrfCoordinator");
    ...
    constructor(address _vrfCoordinator, address _jst, address _justMid) public {
        ...
        setJustMid(_justMid);
        vrfCoordinatorProxy = _vrfCoordinator;
    ...
    function rawFulfillRandomness(bytes32 requestId, uint256 randomness) external {
        require(msg.sender == vrfCoordinator.getVrfCoordinator(), "Only VRFCoordinator can fulfill");
        fulfillRandomness(requestId, randomness);
    }

    function getVrfCoordinator() external override view returns (address) {
        return vrfCoordinator.getVrfCoordinator();
    }
}
